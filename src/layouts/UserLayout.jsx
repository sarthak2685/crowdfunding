...
const UserLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Mobile Header */}
      <div className="md:hidden bg-white shadow-sm py-4 px-6 flex justify-between items-center">
        <Link to="/" className="flex items-center space-x-2">
          <span className="font-bold text-xl text-primary">Fund<span className="text-secondary">Together</span></span>
        </Link>
      ...
      <div className="flex">
        ...
        <aside className="hidden md:flex flex-col w-64 border-r bg-white min-h-screen">
          ...
          <div className="p-4 border-t">
            ...
            <button
              onClick={handleLogout}
              className="w-full flex items-center space-x-3 px-3 py-2 rounded-md text-red-500 hover:bg-red-50"
            >
              <LogOut size={18} />
              <span>Logout</span>
            </button>
