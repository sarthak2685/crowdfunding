...
import { CalendarClock, Target, Users, DollarSign } from 'lucide-react';
    ...
    try {
      ...
      if (data.success) {
        toast({
          ...
          description: "Your donation is being processed. You will be redirected to complete it.",
        });
        ...
        if (paymentResult.success) {
          ...
          toast({
            ...
            description: paymentResult.message || "There was a problem processing your donation.",
            variant: "destructive"
          });
        }
      } else {
        toast({
          title: "Donation Failed",
          description: data.message || "There was a problem processing your donation.",
          variant: "destructive"
        });
      }
    } catch (error) {
      ...
      <div className="campaign-card bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all">
        ...
        <div className="p-5">
          ...
          <div className="mt-3 mb-3">
            ...
            >
              <DollarSign className="w-4 h-4 mr-2" /> Donate Now
            </Button>
          </div>
      ...
      <Dialog open={showDonateDialog} onOpenChange={setShowDonateDialog}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter the amount you would like to donate to support this campaign.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button onClick={() => setShowDonateDialog(false)} variant="outline" disabled={isLoading}>
              Cancel
            </Button>
            <Button onClick={handleDonationSubmit} disabled={isLoading}>
