        ...
        switch (status) {
            case "active":
                return (
                    <Badge
                        variant="outline"
                        className="bg-[#95D5B2]/20 px-4 py-2 text-[#2D6A4F] border-[#95D5B2]"
                    >
                        Active
                    </Badge>
                );
            case "pending":
                return (
                    <Badge
                        variant="outline"
                        className="bg-[#EF476F]/20 px-4 py-2 text-[#EF476F] border-[#EF476F]"
                    >
                        Pending
                    </Badge>
                );
            case "completed":
                return (
                    <Badge
                        variant="outline"
                        className="bg-[#2D6A4F]/20 px-4 py-2 text-[#2D6A4F] border-[#2D6A4F]"
                    >
                        Completed
                    </Badge>
                );
            case "rejected":
                return (
                    <Badge
                        variant="outline"
                        className="bg-[#EF476F]/20 px-4 py- text-[#EF476F] border-[#EF476F]"
                    >
                        Rejected
                    </Badge>
                );
                                            ...
                                            <TableBody>
                                                ...
                                                recentCampaigns.length > 0 ? (
                                                    ...
                                                    <TableRow>
                                                        <TableCell
                                                            colSpan={6}
                                                            className="text-center py-6 text-[#1B1B1E]/80"
                                                        >
                                                            No campaigns found
                                                        </TableCell>
                                                    </TableRow>
                                                    ...
                                                    recentCampaigns
                                                        ...
                                                        .map((campaign) => (
                                                            ...
                                                            >
                                                                ...
                                                                <TableCell className="text-right">
                                                                    <Link
                                                                        to={`/admin/approvals/${campaign._id}`}
                                                                    >
                                                                        <Button
                                                                            variant="outline"
                                                                            size="sm"
