                ...
                setTimeout(() => {
                    const dummyCampaigns = [
                        ...
                        },
                        {
                            ...
                            description:
                                "Providing art supplies and education to underprivileged children to foster creativity and self-expression.",
                            creator: {
                                name: "David Thompson",
                            ...
                            status: "rejected",
                            rejectionReason:
                                "Insufficient details about the implementation plan and budget allocation.",
                            imageUrl:
        ...
        switch (status) {
            case "active":
                return (
                    <Badge
                        variant="outline"
                        className="bg-[#95D5B2]/20 px-2 text-[#2D6A4F] border-[#95D5B2]"
                    >
                        Active
                    </Badge>
                );
            case "pending":
                return (
                    <Badge
                        variant="outline"
                        className="bg-[#EF476F]/20 px-2 text-[#EF476F] border-[#EF476F]"
                    >
                        Pending
                    </Badge>
                );
    ...
    const confirmRejection = async () => {
        ...
        try {
            ...
            toast({
                ...
                description:
                    "The campaign has been rejected and the creator has been notified.",
                duration: 3000,
            });
        } catch (error) {
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="flex flex-wrap gap-3 mt-4">
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="flex flex-wrap rounded-full px-4 py-2"
                                ...
                                {campaign.status === "pending" && (
                                    <>
                                        <Button
                                            variant="default"
                                            size="sm"
                                            className="flex flex-wrap rounded-full px-4 py-2 bg-forest-green/20 hover:bg-forest-green font-semibold text-forest-green hover:text-white"
                                            onClick={() =>
                                                handleApproveCampaign(campaign)
                                            }
                                        >
                                            <CheckCircle2
                                                size={16}
                                        ...
                                        <Button
                                            variant="destructive"
                                            size="sm"
                                            className="flex flex-wrap rounded-full px-4 py-2 text-coral-red bg-coral-red/10 hover:bg-coral-red hover:text-white"
                                            onClick={() =>
                                                handleRejectCampaign(campaign)
                                            }
                                        >
                                            <XCircle
                                                size={16}
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                ...
                                be shared with the campaign creator.
                            </DialogDescription>
                        </DialogHeader>
